...
/**
 * Class de gere la creation des nodes
...
public class GestionNode extends JFrame{
	...
	/**
	 * JList contenant les composant creer
	 */
	public JList listNode;
	
	/**
	 * JButton permettant de creer un composant
	 */
	public JButton creer;
	
	/**
	 * JButton permettant de supprimer un composant selectionner
	 */
	public JButton supp;
	
	/**
	 * JButton permettant de passer a l'étape suivante
	 */
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==creer){
				...
				if(!listNode.isSelectionEmpty()){
					...
					JOptionPane.showMessageDialog(null, "Suppression impossible, aucun composant selectionné", "Erreur", JOptionPane.ERROR_MESSAGE);
