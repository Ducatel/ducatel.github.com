 ...
 * id d'un composant reseau, et le poids associer au chemin passant par ce 
 * composant.
...
public class Couple implements Comparable<Couple> {
	...
	/**
	 * Variable contenant le l'id du node
	 */
	private String idNode;
	
	/**
	 * Variable contenant le poids du chemin passant par ce node
	 */
	...
	/**
	 * Methode permettant de recupere le poids du chemon
